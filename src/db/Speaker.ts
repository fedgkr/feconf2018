...
export const speakerList: Speaker[] = [
  ...
  new Speaker({
    ...
    presentDesc:
      '현재 엔테크서비스(NTS)에서 지식iN UI개발 업무를 하고 있습니다. 모션그래픽 디자인, 애니메이션 등을 적용한 인터렉티브 웹 UI개발에 관심이 많고 Interactive Developer가 꿈인 UI개발자입니다.',
    ...
    company: getCompanyByName('엔테크서비스'),
    track: 1,
    order: 4,
  }),
  new Speaker({
  ...
  new Speaker({
    ...
    presentDesc:
      '회사 내에 React 또는 자바스크립트 프레임워크 도입을 고민하고 계신 분들에게 도움이 되었으면 좋겠습니다. 원티드가 jQuery 기반의 초기 구조에서 어떻게 React 기반으로 재작성할 수 있었고 더 나아가 서버렌더링까지 적용할 수 있었는지 과정을 공유합니다.',
